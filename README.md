...
Store website passwords and secure notes in an AES-encrypted vault on your machine. No cloud. No accounts. No tracking.
...
When you run the exe for the first time, Windows will show **"Windows protected your PC"**. This is expected — PassNook is not yet code-signed.

**To bypass:** click **More info**, then **Run anyway**. You will only see this once.

The full source code is public in this repo.

### Disclaimer

PassNook is a personal project offered free of charge. It is provided **"as is"** without warranty of any kind. Brava IT Services assumes no responsibility for lost, corrupted, or inaccessible data. **Your master password is never stored and cannot be recovered** — if you forget it, your vault cannot be unlocked. Always keep a backup.
